    ...
    return (
        <InstructionStyle>
            ...
            <InstructionStep>
                ...
                <p>Logging in let's you save contacts, save the cards you use and generally makes the process so much easier.</p>
            ...
            <InstructionStep>
                ...
                <p>Charge your Pockett with your favorite currency of choice, safely.</p>
            ...
            <InstructionStep>
                ...
                <h2>Transfer away</h2>
                <p>You can use the cash in your Pockett to pay for basically anything online.</p>
                <InstructionButton to="/transfer">
                    Transfer
                </InstructionButton>
            </InstructionStep>
